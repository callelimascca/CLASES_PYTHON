...
boton_borrar = Button(ventana, text = "AC",command = lambda: borrar())
...
button_suma.config(bg="#F5FFD3")
button_resta.config(bg="#F5FFD3")
button_multiplicar.config(bg="#F5FFD3")
button_divide.config(bg="#F5FFD3")
button_igual.config(bg="#F5FFD3")
boton_borrar.config(bg="#F5FFD3")
...
button_igual.grid(row=4, column=1, padx=5, pady=5)
button_suma.grid(row=4, column=3, padx=5, pady=5)
boton_borrar.grid(row=4, column =2, padx=5, pady=5)
ventana.mainloop()
