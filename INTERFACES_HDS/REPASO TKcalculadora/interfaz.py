...
pantalla=Entry(root, 
               ...
               borderwidth=3, #tamaño del borde de cuadro de texto
...
boton_0=Button(root,text="0",width=9,height=3,bg="#E8D7F0", fg="#1A4CEF",borderwidth=0,cursor="hand2",font=fuente_general).grid(row=4, column=1, padx=1, pady=1)
boton_igual=Button(root,text="=",width=9,height=3,bg="#DED7F0", fg="#402FEF",borderwidth=0,cursor="hand2",font=fuente_general).grid(row=4, column=0, padx=1, pady=1)
boton_punto=Button(root,text=".",width=9,height=3,bg="#E8D7F0", fg="#1A4CEF",borderwidth=0,cursor="hand2",font=fuente_general).grid(row=4, column=2, padx=1, pady=1)

#boton de operaciones
boton_suma=Button(root,text="+",width=9,height=3,bg="#94FFF0", fg="#1A4CEF",borderwidth=0,cursor="hand2",font=fuente_general).grid(row=1, column=3, padx=1, pady=1)
boton_resta=Button(root,text="-",width=9,height=3,bg="#94FFF0", fg="#1A4CEF",borderwidth=0,cursor="hand2",font=fuente_general).grid(row=2, column=3, padx=1, pady=1)
boton_multiplicacion=Button(root,text="*",width=9,height=3,bg="#94FFF0", fg="#1A4CEF",borderwidth=0,cursor="hand2",font=fuente_general).grid(row=3, column=3, padx=1, pady=1)
boton_division=Button(root,text="/",width=9,height=3,bg="#94FFF0", fg="#1A4CEF",borderwidth=0,cursor="hand2",font=fuente_general).grid(row=4, column=3, padx=1, pady=1)
